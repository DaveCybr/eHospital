...
<?php echo form_open('Laporan/cetak_diagnosa',array("target"=>"_blank"));?>
    ...
    <div class="card card-cascade narrower z-depth-1">
      ...
      <div class="card-body">
        <div class="row p-t-20">
          ...
          <div class="col-md-3">
            <div class="form-group animated flipIn">
              <label for="exampleInputuname">Berdasarkan Diagnosa</label>
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="basic-addon1"><i class="ti-calendar"></i></span>
                </div>
                <!-- <input type="text" name="noBPJS" id="noBPJS" class="form-control" placeholder="xxxxxxxxxxxxx" value="<?php echo @$pasien['noBPJS']; ?>"> -->
                <input type="text" name="t_diagnosa" id="t_diagnosa" value="" class="form-control">
          ...
          <div class="col-md-3">
            <div class="form-group animated flipIn">
                ...
                <select name="jenis_kelamin" class="mdb-select colorful-select dropdown-info md-form">
          ...
          <div class="col-md-3">
            <div class="form-group animated flipIn">
                <select name="usia" class="mdb-select colorful-select dropdown-info md-form">
                  <option value="">Semua Usia</option>
                  <option value="0,5">Balita (0-5 tahun)</option>
                  <option value="6,11">Anak-anak (6-11 tahun)</option>
                  <option value="12,25">Remaja (12-25 tahun)</option>
                  <option value="26,45">Dewasa (26-45 tahun)</option>
                  <option value="46,120">Lansia ( > 45 Tahun)</option>
                </select>
...
$(document).ready(function() {
    $(document).on("focus","#t_diagnosa",function(){

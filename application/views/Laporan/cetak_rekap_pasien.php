...
<?php
          ...
          $html='<h1 align="center">'.$this->Core->nama_klinik().'</h1><h4 align="center"></h4><h4 align="center">
              '.$this->Core->alamat_klinik().'</h4><h4 align="center">
                '.$this->Core->kontak_klinik().'</h4>&nbsp;&nbsp;<h2 align="center">REKAP PASIEN</h2>
                  ...
                  <table cellspacing="1" border="1" bgcolor="#666666" cellpadding="2">
                      <tr bgcolor="#ffffff">
                          ...
                          <th width="10%" align="center">KUNJUNGAN TERAKHIR</th>
                          <th width="20%" align="center">NAMA PASIEN</th>
                          <th width="10%" align="center">TANGGAL LAHIR</th>
                          <th width="5%" align="center">USIA</th>
                          <th width="5%" align="center">JENIS KELAMIN</th>
                          <th width="15%" align="center">NOMOR TELEPON</th>
                          <th width="10%" align="center">DIAGNOSA</th>
                          <th width="10%" align="center">NAMA PENYAKIT</th>
                        </tr>';
          foreach ($kunjungan as $value)
              {
                  ...
                  $html.='<tr bgcolor="#ffffff">
                          ...
                          <td align="left">'.date("d-m-Y",strtotime($value->kunjungan_terakhir)).'</td>
                          ...
                          <td align="left">'.str_pad($value->telepon, 12, "0", STR_PAD_LEFT).'</td>

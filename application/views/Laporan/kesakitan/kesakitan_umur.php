...
<?php
          ...
          $i=0;
          $html='<h1 align="center">'.$this->Core->nama_klinik().'</h1><h4 align="center">'.$this->Core->alamat_klinik().'</h4>&nbsp;&nbsp;<h2 align="center">LAPORAN 10 BESAR KESAKITAN BERDASAR UMUR</h2>
                  ...
                  <table cellspacing="1" border="0" bgcolor="#666666" cellpadding="2">
                      ...
                      <th style="width:15%;text-align:center">NAMA PENYAKIT</th>
                  ...
                  if (!empty(@$data_html)) {
                    ...
                    foreach ($data_html as $value) {
                      ...
                      $html .= '<tr bgcolor="#ffffff">
                        <th style="width:2%;text-align:center">'.$no.'</th>
                        <th style="width:5%;text-align:center">'.$value['ID_ICD'].'</th>
                        <th style="width:15%;text-align:left">'.$value['IND'].'</th>
          ...
          ob_end_clean();
          $pdf->Output('laporan_kesakitan_umur_'.$sampai.'.pdf', 'I');
?>

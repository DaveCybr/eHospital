  ...
  <div class="col-md-3">
    <div class="form-group animated flipIn">
      ...
      <div class="input-group mb-3">
        ...
        <input type="number" name="jumlah" id="jumlah" min="0" class="form-control" placeholder="0" value="<?php echo @$mbesar['namarek']; ?>" required>
    </div>
    </div>
  </div>
  <div class="col-md-3">
  ...
  <div class="col-md-3">
    <div class="form-group animated flipIn">
      ...
      <div class="input-group mb-3">
        ...
        <input type="number" name="waktu" min="0" id="waktu" class="form-control" placeholder="0" value="<?php echo @$mbesar['namarek']; ?>" required>
          <div class="input-group-append">
  ...
  <div class="col-md-3">
    <div class="form-group animated flipIn">
      ...
      <div class="input-group mb-3">
        ...
        <input type="number" min="0" name="nilai_residu" id="nilai_residu" class="form-control" placeholder="0" value="<?php echo @$mbesar['namarek']; ?>" required>

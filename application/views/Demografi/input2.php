                            ...
                            <div class="col-xl-12 col-md-12 col-sm-12">
                              <div class="form-group animated flipIn">
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <input type="number" min="1" max="6" class="form-control in_max" aria-label="" name="GCS_E" value="<?php echo @$demografi['GCS_E'] ?>">
                                  <div class="input-group-append">
                                    <span class="input-group-text">V</span>
                                  </div>
                                  <input type="number" min="1" max="6" class="form-control in_max" aria-label="" name="GCS_V" value="<?php echo @$demografi['GCS_V'] ?>">
                                  <div class="input-group-append">
                                    <span class="input-group-text">M</span>
                                  </div>
                                  <input type="number" min="1" max="6" class="form-control in_max" aria-label="" name="GCS_M" value="<?php echo @$demografi['GCS_M'] ?>">
                                </div>
                              </div>
                            </div>
                            <div class="col-xl-12 col-md-12 col-sm-12">
                              <div class="form-group animated flipIn">
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <input type="number" max="1000" min="0" class="form-control" aria-label="" name="suhu" value="<?php echo @$demografi['suhu'] ?>" >
                                  <div class="input-group-append">
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <input type="number" max="1000" min="0" class="form-control" aria-label="" name="siastole" value="<?php echo @$demografi['td'] ?>">
                                  <div class="input-group-append">
                                  ...
                                  <input type="number" max="1000" min="0" class="form-control" aria-label="" name="diastole" value="<?php echo @$demografi['hr'] ?>">
                                  <div class="input-group-append">
                                    <span class="input-group-text">mmhg</span>
                                  </div>
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <input type="number" max="1000" min="0" class="form-control" aria-label="" name="nadi" value="<?php echo @$demografi['nadi'] ?>">
                                  <div class="input-group-append">
                                  ...
                                  <input type="number" max="1000" min="0" class="form-control rr" aria-label="" name="rr" value="<?php echo @$demografi['rr'] ?>">
                                  <div class="input-group-append">
                                    <span class="input-group-text">x/menit</span>
                                  </div>

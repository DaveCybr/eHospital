        ...
        <div class="col-lg-12">
          <div class="card card-cascade narrower z-depth-1">
            <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
                  ...
                  <h4><a href="" class="white-text mx-3">Asesmen keperawatan</a></h4>
            ...
            <div class="row col-md-12">
              <a href="<?php echo base_url(); ?>Asesmen/input_lama/<?php echo @$idkunjungan; ?>/<?php echo @$pasien['noRM']; ?>"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal"  style="margin-top: 30px;margin-bottom:10px;"> <i class="fa fa-plus" ></i>Tambah Asesmen</button></a>
              <a href="<?php echo base_url(); ?>Asesmen/edit_lama/<?php echo @$idkunjungan; ?>/<?php echo @$pasien['noRM']; ?>"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" style="margin-top: 30px;margin-bottom:10px;"> <i class="fa fa-search" ></i>Edit Asesmen</button></a>
              <a href=""><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="" style="margin-top: 30px;margin-bottom:10px;"> <i class="fa fa-search" ></i>Detail Asesmen</button></a>
            </div>

<?php echo form_open('KategoriObat/delete'); ?>
  ...
  <div class="col-12">
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        ...
        <a href="" class="white-text mx-3">Kategori Obat</a>
        <div>
          <a href="<?php base_url(); ?>KategoriObat/input" class="float-right">
          ...
          <table id="myTable" class="table table-bordered table-striped table-hover ">
            ...
            <tbody>
              ...
              foreach ($kategori_obat as $data) { ?>
                <?php $id_check = $data->idkategori_obat; ?>
                <tr>
                  <td>
                  ...
                  <td><a href="<?php base_url() ?>KategoriObat/edit/<?php echo $data->idkategori_obat; ?>">

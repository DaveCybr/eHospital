<?php echo form_open('PengajuanObat/delete'); ?>
  ...
  <div class="col-12">
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        ...
        <a href="" class="white-text mx-3">Mutasi Obat</a>
        <div>
          <a href="<?php base_url(); ?>PengajuanObat/input" class="float-right">
            <button type="button" class="btn btn-outline-white btn-rounded btn-sm px-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Pengajuan Obat"><i class="fas fa-mortar-pestle"></i> Permintaan Obat</button>
          </a>
          <a href="<?php base_url(); ?>PengajuanObat/mutasi_input" class="float-right">
            <button type="button" class="btn btn-outline-white btn-rounded btn-sm px-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Mutasi Obat"><i class="fas fa-capsules"></i> Mutasi Obat</button>
          </a>
        </div>
      </div>
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-hover table-striped table-bordered ">
            ...
            <tbody>
              <?php $no = 1;
              foreach ($pengajuan_obat as $data) { ?>
                ...
                <tr>
                  ...
                  <td><?php echo $data->status == 0 ? "Belum Dilayani" : "Sudah Mutasi"; ?></td>
                  <td class="text-center">
                    <?php if ($_SESSION['poli'] == 'IGD') : ?>
                      <!-- <i >Clear</i> -->
                    <?php else : ?>
                      <?php if ($data->status == 0) : ?>
                        <a href="<?php echo base_url() . "PengajuanObat/detail/" . $id_check ?>" class="fitur_layani">
                          <button type="button" class="btn btn-primary btn-sm btn-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Layani">
                      ...
                      <?php endif; ?>
                    <?php endif; ?>
                    <a href="<?php echo base_url() . "PengajuanObat/detail_mutasi/" . $id_check ?>" class="fitur_layani">
                      <button type="button" class="btn btn-success btn-sm btn-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Detail Mutasi Obat">

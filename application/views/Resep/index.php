    ...
    <div class="card card-cascade narrower z-depth-1">
      ...
      <div class="card-body">
        <div class="row col-xl-12">
          ...
          <div class="col-xl-2 col-md-6 col-sm-6">
            <select class="mdb-select colorful-select dropdown-info sm-form" id="jenis">
              <!-- <option value="" disabled selected>Pilih</option> -->
              <option value="" selected>Semua Jenis Pasien</option>
                <?php foreach ($jenis_pasien as $value): ?>
              <option value="<?php echo $value->kode_jenis;?>">
  ...
  $(document).ready(function(){
    ...
    $(document).on("click","#filter_data",function(){
      ...
      $.ajax({
        ...
        data: { tanggal:tgl,sts:sts,poli:poli,ambil:ambil,jenis:jenis},
        beforeSend: function () {

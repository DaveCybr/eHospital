  ...
  <!-- <div class="col-12"> -->
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header purple-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <a href="" class="white-text mx-3">Daftar Pasien Belum Bayar</a>
      </div>
      <div class="card-body">
<div class="table-responsive" id="resep_belum">
  <table id="example_blm" class="table table-bordered table-striped table-hover">
    ...
    <td>
      <?php if ($value->status_resep==1) {?>
        ...
        <?php
        if ($value->ambil!=1) {?>
          <a href="<?php echo $value->billing==1 || $value->acc_ranap==1 || $value->sumber_dana==7?base_url()."Resep/berikan/".$value->no_resep:"#";?>" >

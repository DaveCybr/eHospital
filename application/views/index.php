...
<head>
  ...
  <!-- Favicon icon -->
  <link rel="icon" type="image/png" sizes="16x16" href="<?= $this->Core->logo_klinik(); ?>">
  <title><?= $this->Core->nama_klinik(); ?></title>
  ...
  <link href="<?php echo base_url(); ?>desain/dist/css/pages/chat-app-page.css" rel="stylesheet">
  ...
  <?php if ($jabatan == "direktur" || $jabatan == "root" || $jabatan == "admin" || $jabatan = "apotek") : ?>
    <style>
      .fitur_open {
        display: none;
      }
...
<body class="skin-megna fixed-layout">
  ...
  <!-- <div class="preloader">
    <div class="loader">
      ...
      <p class="loader__label"><?php echo $this->Core->nama_klinik(); ?></p>
    </div>
  </div> -->
  <!-- ============================================================== -->
  ...
  <div id="main-wrapper">
      ...
      <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-header">
          <a class="navbar-brand" href="<?php echo base_url() ?>">
            <!-- Logo icon --><b>
              ...
              <!-- Dark Logo icon -->
              <img src="<?= $this->Core->logo_klinik(); ?>" style="max-width: 55px;" alt="homepage" class="dark-logo" />
              <!-- Light Logo icon -->
              <img src="<?= $this->Core->logo_klinik(); ?>" style="max-width: 55px;" alt="homepage" class="light-logo" />
            </b>
            <!--End Logo icon -->
            <span class="hidden-xs"><span class="font-bold"><?= $this->Core->nama_klinik(); ?></span></span>
          </a>
        </div>
        <!-- ============================================================== -->
        <!-- End Logo -->
        ...
        <div class="navbar-collapse">
          ...
          <ul class="navbar-nav my-lg-0">
            ...
            <?php $this->load->view("APO/notifChat") ?>
            <!-- ============================================================== -->
            <!-- End mega menu -->
            <!-- ============================================================== -->
            <!-- ============================================================== -->
            ...
            <li class="nav-item dropdown u-pro">
              ...
              <div class="dropdown-menu dropdown-menu-right animated flipInY">
                ...
                <!-- <div class="dropdown-divider"></div> -->
                <!-- text-->
                <?php $cek = $this->Core->cek_username($_SESSION['nik'])->num_rows(); ?>
                <?php if ($cek > 1) : ?>
                  <a href="<?php echo base_url(); ?>Login/akses/<?php echo $_SESSION['nik'] ?>" class="dropdown-item"><i class="fa fa-arrow-alt-circle-right"></i> Pindah Sesi</a>
    ...
    <div class="page-wrapper">
      ...
      <div class="container-fluid">
        ...
        if (@$this->session->flashdata('notifPcare')) {
          echo @$this->session->flashdata('notifPcare');
        }
        ?>
    ...
    <!-- ============================================================== -->
    <footer class="footer">
    SIMETRIK V 1.2 Pcare V.4 © 2023 E-SOLUSINDO
    </footer>
    <!-- ============================================================== -->
    <!-- End footer -->
    <!-- ============================================================== -->
  ...
  <script src="<?php echo base_url() ?>desain/dist/js/pages/chat.js"></script>

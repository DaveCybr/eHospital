...
<html lang="en">
<?php
if (!isset($_SESSION['nama']) && !isset($_SESSION['noRM'])) {
  redirect(base_url().'APO/LoginPasien');
}else{
  $menu_diakses = $this->uri->segment(0)."/".$this->uri->segment(1)."/".$this->uri->segment(2);
  $this->Core->save_riwayat($_SESSION['noRM'],date("Y-m-d h:i:s"),$menu_diakses);
}
    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
      ...
      <div class="navbar-header">
        <a class="navbar-brand" href="#">
          ...
          <!-- Dark Logo icon -->
          <img src="<?php echo base_url(); ?>desain/assets/images/<?php echo $this->Core->logo_klinik()?>" style="max-width: 55px;" alt="homepage" class="dark-logo" />
          <!-- Light Logo icon -->
          <img src="<?php echo base_url(); ?>desain/assets/images/<?php echo $this->Core->logo_klinik()?>" style="max-width: 55px;" alt="homepage" class="light-logo" />
        </b>
        <!--End Logo icon -->
        <span class="hidden-xs"><span class="font-bold"><?php echo $this->Core->nama_klinik()?></span></span>
      </a>
    </div>
    <!-- ============================================================== -->
    <!-- End Logo -->
  ...
  <ul class="navbar-nav my-lg-0">
    ...
    <li class="nav-item dropdown u-pro">
      <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <span class="hidden-md-down"><?php echo $_SESSION['nama']." (".$_SESSION['noRM'].")" ?> &nbsp;<i class="fa fa-angle-down"></i></span> </a>

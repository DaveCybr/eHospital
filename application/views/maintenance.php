...
<head>
    ...
    <title>Rumah Sakit Utamahusada</title>
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                <h1>Ops...</h1><br><br>
                <h3 class="text-uppercase">Sistem masih dalam proses maintenance </h3>
                <p class="text-muted m-t-30 ">Harap tunggu beberapa saat. . .  <br>Sistem akan segera pulih</p>

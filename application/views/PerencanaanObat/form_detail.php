                ...
                <table id="list_pembelian_obat" class="table editable-table table-bordered table-striped m-b-0">
                  ...
                  <tbody id="obat">
                    <?php foreach($pengajuan as $value):?>
                      <tr>
                          <td>
                          <?php echo $value->obat_idobat." / ".$value->nama_obat?></td>
                          <td>
                          <?php echo $value->jumlah_pengajuan?></td>
                          <td>
                          <?php echo $value->jumlah_disetujui?></td>
                          <td>
                          <?php echo $value->jumlah_masuk==NULL?0:$value->jumlah_masuk?></td>
                          <td>
                          <?php echo "Rp.".number_format($value->harga_beli)?></td>

                          <td>
                            <?php if ($value->mutasi==1): ?>
                              <span class="badge badge-success">Telah Di Gudang</span>
                              <?php else: ?>
                              <span class="badge badge-danger">On Progres</span>

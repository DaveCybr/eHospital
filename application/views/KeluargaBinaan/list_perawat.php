        ...
        <div class="col-sm-6">
          <div class="row form-group">
              <div class="col col-md-4">
                <label for="nik_dokter" class="form-control-label">NIK Dokter</label>
              </div>
              <div class="col-8 col-md-8">
                <input type="text" name="nik_dokter" id="nik_dokter" disabled class="form-control" value="<?php echo @$dokter['NIK']; ?>">
              </div>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="row form-group">
              ...
              <div class="col-8 col-md-8">
                <input type="text" name="nama" id="nama" disabled class="form-control" value="<?php echo @$dokter['nama']; ?>">
              </div>
          </div>
        </div>
                    ...
                    <?php $no = 1; foreach ($perawat as $data_pegawai):
                      ...
                      <tr>
                        ...
                        <td><?php echo $id_check; ?></td>
                          ...
                          <td>
                            <a href="<?php echo base_url().'K_Binaan/KBDokter/HapusPerawat/'.$id_check.'/'.$dokter['idkb_dokter']; ?>">
                              <button type="button" class="btn btn-danger" data-toggle="tooltip" data-placement="right" title="" data-original-title="Edit">
                          ...
                          <?php $no = 1; foreach ($pegawai as $data_pegawai):
                            ...
                            <tr>
                              ...
                              <td><?php echo $id_check; ?></td>
                                ...
                                <td><?php echo $data_pegawai->jabatan; ?></td>
                                <td>
                                  <a href="<?php echo base_url().'K_Binaan/KBDokter/tambah_perawat/'.$id_check.'/'.$dokter['idkb_dokter']; ?>">

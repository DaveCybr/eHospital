  ...
  <div class="card-body card-block">
    <div class="row form-group">
      ...
      <div class="col-md-12" style="margin-top:20px;">
        <?php echo json_encode($_SESSION['jabatan']) ?>
            ...
            <tbody>
              <?php $no = 1; foreach ($obat as $data):
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" id="<?php echo $id;?>" class="list_batch btn-floating aqua-gradient" data-toggle="tooltip" data-placement="top" title="Tambahkan" data-original-title="TambahKan" >
...
$(document).ready(function(){
  ...
  $(document).on('click','.list_batch',function(){
    ...
    myajax_request(base_url+"Resep/get_batch_retur",data_detail,function(res){
      kosongkan_array();
      var html = "";
  ...
  $(document).on("click",".tambah_batch",function(){
    ...
    if (list_batch.indexOf(id_pengadaan[id]) > -1) {
      ...
      "<td><input type='hidden' name='ed[]' class='form-control'>"+ed[id]+"</td>" +
      "<td><input style='min-width:150px;' type='number' id='jml"+kode_obat+"' kode='"+kode_obat+"' class='form-control jml_beli' name='jumlah[]' value='1'></td>" +

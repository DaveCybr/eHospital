            ...
            <tbody>
              <?php $no = 1; foreach ($obat as $data):
                ...
                <tr>
                  ...
                  <td>
                    <a target="_blank" href="<?php echo base_url()."KartuStokUgd/cetak/".$id?>"><button type="button" id="<?php echo $id;?>" class="list_batch btn-floating aqua-gradient" data-toggle="tooltip" data-placement="top" title="" data-original-title="Lihat Kartu Stok" >

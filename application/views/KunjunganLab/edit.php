        ...
        <div class="col-lg-12">
          <div class="card card-cascade narrower z-depth-1">
            <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
                  <h4><a href="" class="white-text mx-3">Form Pasien</a></h4>
                            ...
                            <?php $no = 0; foreach ($lab as $value):
                              ...
                              <tr>
                                ...
                                <td><?php if (strlen($value->kodelab)>1): ?>
                                  <input type="<?php echo $type?>" <?php echo $min." ".$max;?> name="hasil[]" placeholder="Hasil : <?php echo $value->nama ?>" class="form-control" value="<?php echo $value->hasil;?>"> </td>
                                  <?php else: ?>
                                ...
                                <td><a href="<?php echo base_url()."KunjunganLab/hapus/".$this->uri->segment(3)."/".$this->uri->segment(4)."/".$value->iddetaillab."/".$this->uri->segment(2);?>"><button type="button" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></button></a></td>

...
<head>
  <meta charset="UTF-8">
  <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url(); ?>desain/assets/images/logo_simetrik.png">
  <title>SIMETRIK</title>
  <meta charset="utf-8">
...
<body>
      ...
      <div class="login-form animated fadeInDown delay-0.5s">
        ...
        <div id="login-form">
          <div class="head">
            <img src="<?php echo base_url()?>desain/assets/images/logo_simetrik.png" alt=""/>
          </div>
        <form id="FormLogin">

                              ...
                              <div class="row">
                                <div class="col-xs-12">
                                  <h2 class="page-header">
                                    <img src="  <?php echo $this->Core->logo_klinik()?>" style="max-width: 55px;"/> <?php echo strtoupper($this->Core->nama_klinik())?>
                                  </h2>
      			...
      			<div class="modal fade" id="lab" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
      				<div class="modal-dialog modal-lg" role="document">
                        ...
                        <div class="table-responsive table table-striped">
                              ...
                              <tbody>
                                <?php foreach ($this->ModelBilling->lab2($id)->result() as $value): ?>
                                  <tr>

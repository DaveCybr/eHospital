<div class="main-content">
  <div class="section__content section__content--p30">
    <div class="container-fluid">
      <?php echo form_open_multipart('Periksa/update_ditin/'.$this->uri->segment(3));?>
      <div class="row">
            ...
            <div class="card-body card-block">
              ...
              <div class="table-responsive table table-striped">
                <table class="table color-table info-table" id="s_jasa">
                  ...
                  <tbody id="jasa">
                    <?php $total=0;$j_dokter=0;
                    $j_perawat=0;$j_admin=0;$j_resepsionis=0;
                    foreach ($tindakan as $value): ?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <input hidden value="<?php echo $value->jsmedis?>" name='jasa[]'>
                    ...
                    <?php
                    $total+=$value->harga;
                    $j_dokter+=$value->japel_dokter;
                    $j_perawat+=$value->japel_perawat;
                    $j_admin+=$value->japel_admin;
                    $j_resepsionis+=$value->japel_resepsionis;
                    endforeach; ?>
                  </tbody>
                </table>
              </div>
      ...
      <input type="hidden" name="j_dokter" value="<?php echo $j_dokter?>">
      <input type="hidden" name="j_perawat" value="<?php echo $j_perawat?>">
      <input type="hidden" name="j_admin" value="<?php echo $j_admin?>">
      <input type="hidden" name="j_resepsione" value="<?php echo $j_resepsionis?>">
      <input type="hidden" name="pendapatan" value="<?php echo $total-($j_resepsionis+$j_dokter+$j_admin+$j_perawat)?>">
      <?php echo form_close(); ?>

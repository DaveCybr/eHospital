        ...
        <div class="col col-md-12">
          ...
          <div class="table table-responsive">
            ...
            <tbody id="periksa_gigi">
              <tr>
                <td>Siastole</td>
                <td><?php if ($periksa['osiastole']!=null) {
                  echo $periksa['osiastole'];
                }else{ echo "-" ; }?></td>
              </tr>
              <tr>
                <td>Diastole</td>
                <td><?php if ($periksa['odiastole']!=null) {
                  echo $periksa['odiastole'];
                }else{ echo "-" ; }?></td>
              </tr>
              <tr>
                <td>Gula Darah Sewaktu</td>
                <td><?php if ($periksa['gl_sewaktu']!=null) {
                  echo $periksa['gl_sewaktu'];
                }else{ echo "-" ; }?></td>
              </tr>
              <tr>
                <td>Gula Darah Puasa</td>
                <td><?php if ($periksa['gl_puasa']!=null) {
                  echo $periksa['gl_puasa'];
                }else{ echo "-" ; }?></td>
              </tr>
              <tr>
                <td>Gula Darah Post Prandial</td>
                <td><?php if ($periksa['gl_post_prandial']!=null) {
                  echo $periksa['gl_post_prandial'];
                }else{ echo "-" ; }?></td>
              </tr>
              <tr>
                <td>Gula Darah HBA1C</td>
                <td><?php if ($periksa['gl_hba']!=null) {
                  echo $periksa['gl_hba'];
                }else{ echo "-" ; }?></td>
              </tr>
                <tr>

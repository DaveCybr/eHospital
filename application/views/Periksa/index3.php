                  ...
                  <div class="col-md-6 col-xl-3 col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                        ...
                        <input type="text" name="no_pemeriksaan" id="no_pemeriksaan" class="form-control" placeholder="No Pemeriksaan" value="<?php echo  @$periksa['idperiksa']; ?>" required readonly>
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body card-block">
              ...
              <?php echo @$error;?>
              <input type="text" name="no_pemeriksaan" id="no_pemeriksaan" class="form-control" placeholder="No Pemeriksaan" value="<?php echo  @$periksa['idperiksa']; ?>" hidden readonly >
                        ...
                        <div class="col-md-4">
                          <div class="form-group animated flipIn">
                            ...
                            <div class="input-group mb-3">
                              ...
                              <input type="number" name="lingkar_perut" class="form-control" placeholder="TB" value="<?php echo $kunjungan['lingkar_perut']?>" >
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-6">
                          <div class="form-group animated flipIn">
                            ...
                            <div class="input-group mb-3">
                              ...
                              <?php $nadi = ($kunjungan['nadi'] > 0 || $kunjungan['nadi'] != null) ? $kunjungan['nadi'] : '80';?>
              ...
              <div class="col col-sm-12 com-md-12">
                ...
                <?php if (@$periksa['idperiksa'] != ''||@$periksa['idperiksa'] != null): ?>
                  <button type="button" onclick="tes()" id="tindakan" class="btn btn-info btn-sm pull-right">Edit</button>
                  <a href="<?php echo base_url('Periksa/tindakan/'.@$periksa['idperiksa']); ?>"><button type="button" id="tindakan" class="btn btn-success btn-sm pull-right">Tindakan</button></a>
...
<div class="fixed-action-btn direction-top"><a class="btn-floating purple-gradient btn-lg gradient-shadow" data-toggle="tooltip" data-placement="left" title="Menu"><i class="fas fa-bars"></i></a>
  <ul style="height: 270px;">
    <li><a href="css-helpers.html" class="btn-floating blue btn-sm" ><i class="material-icons">help_outline</i></a></li>
    <li><a href="cards-extended.html" class="btn-floating green btn-sm" ><i class="material-icons">widgets</i></a></li>
    <li><a href="app-calendar.html" class="btn-floating amber btn-sm" ><i class="material-icons">today</i></a></li>
    <li>
      <a href="app-email.html" class="btn-floating red btn-sm" data-toggle="tooltip" data-placement="left" title="Tooltip on bottom">

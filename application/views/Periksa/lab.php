<div class="main-content">
  <div class="section__content section__content--p30">
    <div class="container-fluid">
      <?php echo form_open_multipart('Periksa/input_labkun');?>
      <div class="row">
        <div class="col-lg-12">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="card card-cascade narrower z-depth-1">
                      ...
                      <a href="<?php echo base_url() ?>Periksa/index/<?php echo $no_urutkunjungan ?>">
                        <button type="button" class="btn btn-outline-success btn-sm pull-left"><i class="fa fa-reply"></i> LEWATI</button>
                      </a>
